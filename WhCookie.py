...
class WhCookie(unittest.TestCase):
    ...
    def test_cookies_added(self):
        ...
        print(' The number of cookies after cookie button is clicked is: ', len(cookies_before))
        cdb_cookie1 = self.driver.get_cookie('cdb')
        # print('Is there a cdb cookie before the cookie button is clicked: ', cdb_cookie1 is not None)
        assert cdb_cookie1 is None
        ...
        print('       The number of cookies after cookie button is clicked increased with 1: ',
              (len(cookies) - len(cookies_before) == 1))
